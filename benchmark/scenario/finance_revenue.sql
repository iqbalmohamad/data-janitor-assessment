-- DA; run at period close
WITH close_calendar(accounting_period, closed_at) AS (VALUES
{{calendar}}
), billed AS (
 ...
 JOIN close_calendar c ON c.accounting_period=i.accounting_period
 ...
 FROM core.credit_notes n JOIN close_calendar c ON c.accounting_period=n.accounting_period
 ...
 FROM close_calendar c LEFT JOIN billed b USING(accounting_period)
...
FROM pnl ORDER BY accounting_period
